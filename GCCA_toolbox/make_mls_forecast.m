function [test_predictions] = make_part_forecast(X);
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This is uses the stored output from "bayes_partition_gauss.m" to make predictions on a test set
%
%
...
%	USAGE:
%			
%        Samples from the post burn Markov chain are stored in subdirectory ./PARTITION_MCMC_samples
%
%			THIS PROGRAM MUST BE RUN IN THE PARENT DIRECTORY OF "./PARTITION_MCMC_samples"
%
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
for i=1:its
   ...
   for j=2:model.k
      X_basis(:,j) = gen_mls_response(X,model.basis(j));
   end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [X_base]=gen_mls_response(X,basis);
% generates response of a multivariate linear spline basis
% INPUTS:
%		X - data
...
% get the covariates that interact in the basis function (plus intecept)
x = [X(:,basis.var) ones(n,1)];

% get response of the basis function
x = x*basis.knot;
